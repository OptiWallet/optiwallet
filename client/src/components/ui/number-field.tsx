...
export const NumberFieldInput = <T extends ValidComponent = "input">(
  ...
  return (
    <NumberFieldPrimitive.Input
      class={cn(
        "flex h-9 w-24 rounded-md border border-input bg-transparent px-10 py-1 text-center text-sm shadow-sm placeholder:text-muted-foreground focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
        local.class
      )}
      {...rest}
    />
